...
=== intro ===
# CLEAR
# HEADER: img/profile.jpg

# HR: simple
<b><i><center>By understanding who we are, we can decide what requires our attention</center></i></b>

# HR: simple
Hi, I'm Mara!  I'm a 3rd year PhD student working with <a href="https:faculty.washington.edu/ajko/">Amy J. Ko</a>.
...
I'm also working on integrating critical pedagogy into computer systems courses, sufacing students understandints of <i>how we got here</i>, instead of solely explaning how computer systems work.
...
# I'm working to change the narrative around computing (currently vying for the most ubiquitous trade) from "something that software engineers do when they move fast and break things" to "a tool that can create profound societal change and must be used as a force for liberation".
...
We're just going to take a few breaths.
...
{not breath_suffix} -> breath_suffix
{breath_suffix} -> choices

= breath_suffix
You can continue at whatever pace feels good for you.
There's no need to rush through this.
Feel free to continue whenever you're ready.
-> choices

= choices
+ [I'd like a few more guided breaths]
-> breath
...
I haven't published much, but stay tuned!

<a href="https:doi.org/10.1145/3424000">It's time for more Critical CS Education</a>.  Amy J. Ko, Alannah Oleson, <b>Mara Kirdani-Ryan</b>, Yim Register, Benjamin Xie, Mina Tari, Matthew Davidson, Stefania Druga, and Dastyni Loksa. <i>Communications of the ACM</i>, 31–33. November 2020.
+ [Go back]
-> intro
